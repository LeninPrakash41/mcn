...
class MCNRuntime:
    ...
    def trigger(
        self, endpoint: str, payload: Dict = None, method: str = "POST"
    ) -> Dict:
        ...
        try:
            ...
            if method.upper() == "GET":
                response = requests.get(
                    endpoint, params=payload, headers=headers, timeout=30
                )
        ...
        try:
            ...
            if operation == "find":
                ...
                result = collection.update_many(
                    filter_data, query_data.get("update", {})
                )
    ...
    def write_file(self, file_path: str, content: str, append: bool = False) -> Dict:
        ...
        try:
            ...
            return {
                "success": True,
                "message": f"File {'appended' if append else 'written'}: {file_path}",
            }
        except Exception as e:
            return {"success": False, "error": str(e)}
    ...
    def _setup_logging(self):
        ...
        logging.basicConfig(
            ...
            handlers=[logging.FileHandler("mcn_runtime.log"), logging.StreamHandler()],
        )
