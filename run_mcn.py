...
def main():
    ...
    parser = argparse.ArgumentParser(description='MCN (Macincode Scripting Language) Runner')
    parser.add_argument('command', nargs='?', default='repl', help='Command to run (run, repl, serve)')
    ...
    mcn_lang_path = os.path.join(script_dir, 'mcn-lang')
