...
class MCNInterpreter:
    ...
    def _init_v2_features(self):
        ...
        from .mcn_extensions import MCNAIContext, MCNPackageManager, MCNAsyncRuntime, MCNTypeChecker
        from .mcn_extensions import create_db_package, create_http_package, create_ai_package
    ...
    def execute(self, code: str, file_path: str = None, quiet: bool = False) -> Any:
        ...
        try:
            ...
            if not quiet:
                log_performance("MCN execution", execution_time,
