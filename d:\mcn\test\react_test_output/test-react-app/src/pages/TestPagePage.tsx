...
export function TestPagePage() {
    ...
    const loadPageData = useCallback(async () => {
        try {
            ...
            const result: ApiResponse = await mcn.call('load_page_data', { page: 'TestPage' });
    ...
    return (
        <div className="page page-testpage min-h-screen bg-gray-50">
            
            <UIButton 
                text="Test Button"
                className="btn"
                onClick={() => mcn.call('test_action', {})}
            />
        </div>
    );
}
