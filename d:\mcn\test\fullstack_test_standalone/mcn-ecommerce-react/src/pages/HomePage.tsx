...
export function HomePage() {
    ...
    const loadPageData = useCallback(async () => {
        try {
            ...
            const result: ApiResponse = await mcn.call('load_page_data', { page: 'Home' });
    ...
    return (
        <div className="page page-home min-h-screen bg-gray-50">
            
            <UIContainer className="main-app">
                
            <UIText 
                content="MCN E-Commerce Store"
                tag="h1"
                className="logo"
            />
            <UIInput 
                ...
                onChange={(value) => mcn.call('search_products', {value})}
            />
            <UIButton 
                text="Cart (0)"
                className="cart-btn"
                onClick={() => mcn.call('view_cart', {})}
            />
            <UITable 
