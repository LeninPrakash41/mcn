...
class MSLLogger:
    """Enhanced logging system for MSL with developer-friendly error messages"""
    ...
    def setup_loggers(self):
        ...
        # Main MSL logger
        self.msl_logger = logging.getLogger('msl')
        self.msl_logger.setLevel(logging.DEBUG)
        
        # Error logger for critical issues
        self.error_logger = logging.getLogger('msl.errors')
        self.error_logger.setLevel(logging.ERROR)
        
        # Developer logger for debugging
        self.dev_logger = logging.getLogger('msl.dev')
    ...
    def _setup_handlers(self):
        ...
        # File handlers
        error_handler = logging.FileHandler(self.log_dir / 'msl_errors.log')
        ...
        debug_handler = logging.FileHandler(self.log_dir / 'msl_debug.log')
        ...
        self.msl_logger.addHandler(console_handler)
        self.msl_logger.addHandler(debug_handler)
        self.error_logger.addHandler(error_handler)
        self.dev_logger.addHandler(debug_handler)
        
    def log_msl_error(self, error_type: str, message: str, context: Dict[str, Any] = None, 
                      line_number: int = None, file_path: str = None):
        """Log MSL-specific errors with context"""
    ...
    def _provide_error_tips(self, error_type: str):
        ...
        tips = {
            'SYNTAX_ERROR': [
                ...
                "Verify MSL syntax matches the documentation",
                "Use MSL IDE extension for syntax highlighting"
            ],
            'RUNTIME_ERROR': [
        ...
        error_tips = tips.get(error_type, ["Check MSL documentation for guidance"])
    ...
    def log_warning(self, message: str, context: Dict[str, Any] = None):
        ...
        self.msl_logger.warning(f"{message} | Context: {json.dumps(context or {})}")

# Global logger instance
msl_logger = MSLLogger()

def log_error(error_type: str, message: str, **kwargs):
    """Convenience function for logging errors"""
    msl_logger.log_msl_error(error_type, message, **kwargs)

def log_step(step: str, **kwargs):
    """Convenience function for logging execution steps"""
    msl_logger.log_execution_step(step, kwargs)

def log_performance(operation: str, duration: float, **kwargs):
    """Convenience function for logging performance"""
    msl_logger.log_performance(operation, duration, kwargs)